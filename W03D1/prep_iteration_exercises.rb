...
class Array
  ...
  def bubble_sort(&prc)
    new_array = self.dup # give a new array and changing the memory location
    sorted = false
    while !sorted
      sorted = true
...
# p [5, 1, 3, 5, 3].bubble_sort! { |num1, num2| num1 <=> num2 } #sort ascending
# p [1, 3, 5].bubble_sort! { |num1, num2| num2 <=> num1 } #sort descending

# arr1 = [5, 1, 3, 5, 3]
# p arr1.bubble_sort { |num1, num2| num1 <=> num2 } #sort ascending
# p arr1
# arr2 = [1, 3, 5]
# p arr2.bubble_sort { |num1, num2| num2 <=> num1 } #sort descending
# p arr2
